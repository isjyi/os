...
type GinJWTMiddleware struct {
	...
	// Set permission role key
	RoleIdKey string

	// Set user nickname key
	NiceKey string
...
var (
	...
	// ErrInvalidVerificationode Verification code is invalid
	ErrInvalidVerificationode = errors.New("verification code invalid")

	// IdentityKey default identity key
	IdentityKey = "uid"

	// NiceKey default user nickname key
	NiceKey = "nickname"

	// RoleIdKey default role key
	RoleIdKey = "rid"
)
...
func (mw *GinJWTMiddleware) middlewareImpl(c *gin.Context) {
	...
	if !mw.Authorizator(identity, c) {
		mw.unauthorized(c, http.StatusForbidden, ErrForbidden)
		return
	}
